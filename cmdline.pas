...
var
    ...
    prev_cmd: string; //предыдуща€ команда
    cmd: string; //команда после разбиени€ строки
...
begin
    ...
    begin
        //если команда не соответствует регул€рному выражению expr
        writeln(#10#13,' оманда   *',cmdstr,'*  не найдена');
        cmdstr := '';
    end
    Else
    begin
...
begin
    ...
    begin
        WriteLn(#10#13,'ћаксимальна€ длина строки 80 символов');
        cmdstr := '';
    end
    else
    begin
